...
public class ExpenseTrackerView extends JFrame implements ExpenseTrackerModelListener {
  ...
  /**
   * Getter method for transactions table
   * 
  ...
  /**
   * Action Listener for Apply Category filter button
   * 
   * @param listener
   */
  ...
  /**
   * Getter Method for Category filter input
   * 
   * @return
   */
  ...
  /**
   * Action listener for Apply Amount filter button
   * 
   * @param listener
   */
  ...
  /**
   * Getter method for Amount Filter Input
   * 
   * @return 0.0
   */
  ...
  /**
   * Getter method for Add Transactions button
   * 
   * @return
   */
  ...
  /**
   * Method for highlighting rows based on the applied filter
   * 
   * @param rowIndexes
   */
